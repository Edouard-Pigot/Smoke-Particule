...
void GLArea::makeGLObjects()
{
    ...
    QImage image_particule(":/textures/puffs2.png");
    if (image_particule.isNull())
        qDebug() << "load image puffs2.png failed";
...
void GLArea::paintGL()
{
    ...
    glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
    smoke->animate(dt);
    smoke->display(program_particule, vbo_particule);
...
void GLArea::keyPressEvent(QKeyEvent *ev)
{
    ...
    switch(ev->key()) {
        ...
        case Qt::Key_Up :
            smoke->position += QVector3D(0, 0, -.1);
            break;
        case Qt::Key_Down :
            smoke->position += QVector3D(0, 0, .1);
            break;
        case Qt::Key_Right :
            smoke->position += QVector3D(.1, 0, 0);
            break;
        case Qt::Key_Left :
            smoke->position += QVector3D(-.1, 0, 0);
            break;
